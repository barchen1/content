...
def update_round_set_and_sleep_if_round_completed(executed_in_current_round: set,
    ...
    if str(t) in executed_in_current_round:
        prints_manager.add_print_job(
            'all tests in the queue was executed, sleeping for 60 seconds to let locked tests get unlocked.'
            f' Remaining tests in the queue are: {unmockable_tests_queue.queue}',
            print,
            thread_index)
